            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" style="padding:5px;padding-top:30px">
                        <p>Gutschrift für Rechnungsnummer {{$appointment->id}}</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <table border="0" style="width:730px;border-collapse:collapse;padding-bottom:30px;">
            ...
            <tr>
                ...
                @if($coach->small_business)
                    ...
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['user_credit_per']}}%</td>
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['user_return_gross']}} €</td>
                @else
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['net_per_hr']}} €</td>
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['user_credit_per']}}%</td>
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['user_return_net']}} €</td>
                @endif
            </tr>
            <tr>
                ...
                @else
                    ...
                    <td style="padding:5px;font-size:14px;border-bottom:1px solid #000000;">{{$cost_calculation['user_return_vat']}} €</td>
                @endif
            </tr>
            <tr>
                <td></td>
            ...
            @if($coach->small_business)
                <tr>
                    <td style="padding:5px;font-size:14px;">
                        Gemäß §19 UStG enthält der Gutschriftsbetrag keine Umsatzsteuer.
                    </td>
                </tr>
            @endif
            <tr>
                <td style="padding:5px;font-size:14px;">
                    Der Gutschriftsbetrag wird deinem verwendeten Zahlungsmittel gutgeschrieben.
                </td>
            </tr>
        </table>
    </body>
