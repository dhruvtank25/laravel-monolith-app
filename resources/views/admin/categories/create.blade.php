                ...
                <div class="panel-body">
                    ...
                    <form action="{{  url('admin/categories/') }}" method="POST" id="categoryform" enctype="multipart/form-data">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input id="title" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Category Title" value="{{ old('title') }}" required />
                                @error('title')
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input id="url_slug" name="url_slug" type="text" class="form-control @error('url_slug') is-invalid @enderror" placeholder="Category Url" value="{{ old('url_slug') }}" required />
                                @error('url_slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror" cols="30" rows="10" required>{{ old('short_description') }}</textarea>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" cols="30" rows="10" required>{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
