...
* [#14620](https://dev.ckeditor.com/ticket/14620): Fixed: Setting both the `min-height` style for the `
<!-- Mirrored from seantheme.com/color-admin-v4.3/admin/assets/plugins/ckeditor/CHANGES.md by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2019 10:04:53 GMT -->
<body>` element and the `height` style for the `<html>` element breaks the [Auto Grow](https://ckeditor.com/cke4/addon/autogrow) plugin.
